"""
C2D ResNet: 3d network with spatial-only convolution
...
__all__ = ['C2D_ResNet', 'c2d_resnet18', 'c2d_resnet34', 'c2d_resnet50', 'c2d_resnet101', 'c2d_resnet103',
           'c2d_resnet152', 'c2d_resnext50_32x4d', 'c2d_resnext101_32x8d',
           'c2d_wide_resnet50_2', 'c2d_wide_resnet101_2']
...
class C2D_ResNet(nn.Module):
    ...
    def __init__(self, block, layers, pooling_arch, early_stride=4, num_classes=400, dropout_ratio=0.5, zero_init_residual=False,
        ...
        super(C2D_ResNet, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm3d
...
def _c2d_resnet(arch, block, layers, pooling_arch, image_size=None, **kwargs):
    model = C2D_ResNet(block, layers, pooling_arch, **kwargs)
    return model


@register_model
def c2d_resnet18(pooling_arch, **kwargs):
    ...
    """
    return _c2d_resnet('resnet18', BasicBlock, [2, 2, 2, 2], pooling_arch,
                   **kwargs)


@register_model
def c2d_resnet34(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _c2d_resnet('resnet34', BasicBlock, [3, 4, 6, 3], pooling_arch,
                   **kwargs)


@register_model
def c2d_resnet50(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _c2d_resnet('resnet50', Bottleneck, [3, 4, 6, 3], pooling_arch,
                   **kwargs)


@register_model
def c2d_resnet101(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _c2d_resnet('resnet101', Bottleneck, [3, 4, 23, 3], pooling_arch,
                   **kwargs)


@register_model
def c2d_resnet103(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _c2d_resnet('resnet103', Bottleneck, [3, 4, 23, 3], pooling_arch, deep_stem=True,
                   **kwargs)
                   

@register_model
def c2d_resnet152(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _c2d_resnet('resnet152', Bottleneck, [3, 8, 36, 3], pooling_arch,
                   **kwargs)


@register_model
def c2d_resnext50_32x4d(pooling_arch, **kwargs):
    ...
    return _c2d_resnet('resnext50_32x4d', Bottleneck, [3, 4, 6, 3],
                   pooling_arch, **kwargs)


@register_model
def c2d_resnext101_32x8d(pooling_arch, **kwargs):
    ...
    return _c2d_resnet('resnext101_32x8d', Bottleneck, [3, 4, 23, 3],
                   pooling_arch, **kwargs)


@register_model
def c2d_wide_resnet50_2(pooling_arch, **kwargs):
    ...
    return _c2d_resnet('wide_resnet50_2', Bottleneck, [3, 4, 6, 3],
                   pooling_arch, **kwargs)


@register_model
def c2d_wide_resnet101_2(pooling_arch, **kwargs):
    ...
    """
    kwargs['width_per_group'] = 64 * 2
    return _c2d_resnet('wide_resnet101_2', Bottleneck, [3, 4, 23, 3],
                   pooling_arch, **kwargs)
