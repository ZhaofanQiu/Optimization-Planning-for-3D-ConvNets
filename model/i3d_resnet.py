"""
I3D ResNet
A PyTorch implement of I3D ResNet as described in
...
__all__ = ['I3D_ResNet', 'i3d_resnet18', 'i3d_resnet34', 'i3d_resnet50', 'i3d_resnet101', 'i3d_resnet103',
           'i3d_resnet152', 'i3d_resnext50_32x4d', 'i3d_resnext101_32x8d',
           'i3d_wide_resnet50_2', 'i3d_wide_resnet101_2']
...
def conv3x3x3(in_planes, out_planes, stride=1, groups=1, dilation=1):
    ...
    return nn.Conv3d(in_planes, out_planes, kernel_size=[3, 3, 3], stride=[1, stride, stride],
                     padding=[dilation, dilation, dilation], groups=groups, bias=False, dilation=[dilation, dilation, dilation])
    ...
    for k, v in state_dict.items():
        ...
        if ('conv' in k) or ('downsample.0' in k):
            ...
            if (shape[2] == 3) and (shape[3] == 3) and ('layer' in k):  # basic conv3x3 layer
                v = np.concatenate((v, v, v), axis=2) / 3
...
def _i3d_resnet(arch, block, layers, pooling_arch, image_size=None, **kwargs):
    model = I3D_ResNet(block, layers, pooling_arch, **kwargs)
    return model


@register_model
def i3d_resnet18(pooling_arch, **kwargs):
    ...
    """
    return _i3d_resnet('resnet18', BasicBlock, [2, 2, 2, 2], pooling_arch,
                   **kwargs)


@register_model
def i3d_resnet34(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _i3d_resnet('resnet34', BasicBlock, [3, 4, 6, 3], pooling_arch,
                   **kwargs)


@register_model
def i3d_resnet50(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _i3d_resnet('resnet50', Bottleneck, [3, 4, 6, 3], pooling_arch,
                   **kwargs)


@register_model
def i3d_resnet101(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _i3d_resnet('resnet101', Bottleneck, [3, 4, 23, 3], pooling_arch,
                   **kwargs)


@register_model
def i3d_resnet103(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _i3d_resnet('resnet103', Bottleneck, [3, 4, 23, 3], pooling_arch, deep_stem=True,
                   **kwargs)
                   

@register_model
def i3d_resnet152(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _i3d_resnet('resnet152', Bottleneck, [3, 8, 36, 3], pooling_arch,
                   **kwargs)


@register_model
def i3d_resnext50_32x4d(pooling_arch, **kwargs):
    ...
    return _i3d_resnet('resnext50_32x4d', Bottleneck, [3, 4, 6, 3],
                   pooling_arch, **kwargs)


@register_model
def i3d_resnext101_32x8d(pooling_arch, **kwargs):
    ...
    return _i3d_resnet('resnext101_32x8d', Bottleneck, [3, 4, 23, 3],
                   pooling_arch, **kwargs)


@register_model
def i3d_wide_resnet50_2(pooling_arch, **kwargs):
    ...
    return _i3d_resnet('wide_resnet50_2', Bottleneck, [3, 4, 6, 3],
                   pooling_arch, **kwargs)


@register_model
def i3d_wide_resnet101_2(pooling_arch, **kwargs):
    ...
    """
    kwargs['width_per_group'] = 64 * 2
    return _i3d_resnet('wide_resnet101_2', Bottleneck, [3, 4, 23, 3],
                   pooling_arch, **kwargs)
