"""
P3D-A ResNet
A PyTorch implement of P3D-A ResNet as described in
...
def _p3da_resnet(arch, block, layers, pooling_arch, image_size=None, **kwargs):
    model = P3DA_ResNet(block, layers, pooling_arch, **kwargs)
    return model


@register_model
def p3da_resnet18(pooling_arch, **kwargs):
    ...
    """
    return _p3da_resnet('resnet18', BasicBlock, [2, 2, 2, 2], pooling_arch,
                   **kwargs)


@register_model
def p3da_resnet34(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _p3da_resnet('resnet34', BasicBlock, [3, 4, 6, 3], pooling_arch,
                   **kwargs)


@register_model
def p3da_resnet50(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _p3da_resnet('resnet50', Bottleneck, [3, 4, 6, 3], pooling_arch,
                   **kwargs)


@register_model
def p3da_resnet101(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _p3da_resnet('resnet101', Bottleneck, [3, 4, 23, 3], pooling_arch,
                   **kwargs)


@register_model
def p3da_resnet103(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _p3da_resnet('resnet103', Bottleneck, [3, 4, 23, 3], pooling_arch, deep_stem=True,
                   **kwargs)


@register_model
def p3da_resnet152(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _p3da_resnet('resnet152', Bottleneck, [3, 8, 36, 3], pooling_arch,
                   **kwargs)


@register_model
def p3da_resnext50_32x4d(pooling_arch, **kwargs):
...
@register_model
def p3da_resnext101_32x8d(pooling_arch, **kwargs):
...
@register_model
def p3da_wide_resnet50_2(pooling_arch, **kwargs):
...
@register_model
def p3da_wide_resnet101_2(pooling_arch, **kwargs):
