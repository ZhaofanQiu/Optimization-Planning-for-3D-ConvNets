"""
P3D-B ResNet
A PyTorch implement of P3D-B ResNet as described in
...
__all__ = ['P3DB_ResNet', 'p3db_resnet18', 'p3db_resnet34', 'p3db_resnet50', 'p3db_resnet101', 'p3db_resnet103',
           'p3db_resnet152', 'p3db_resnext50_32x4d', 'p3db_resnext101_32x8d',
           'p3db_wide_resnet50_2', 'p3db_wide_resnet101_2']
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.conv1_t = conv3x1x1(planes, planes, stride)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.conv2_t = conv3x1x1(width, width, stride)
...
class P3DB_ResNet(nn.Module):
    ...
    def __init__(self, block, layers, pooling_arch, early_stride=4, num_classes=400, dropout_ratio=0.5, zero_init_residual=False,
        ...
        super(P3DB_ResNet, self).__init__()
        if norm_layer is None:
...
def _p3db_resnet(arch, block, layers, pooling_arch, image_size=None, **kwargs):
    model = P3DB_ResNet(block, layers, pooling_arch, **kwargs)
    return model


@register_model
def p3db_resnet18(pooling_arch, **kwargs):
    ...
    """
    return _p3db_resnet('resnet18', BasicBlock, [2, 2, 2, 2], pooling_arch,
                   **kwargs)


@register_model
def p3db_resnet34(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _p3db_resnet('resnet34', BasicBlock, [3, 4, 6, 3], pooling_arch,
                   **kwargs)


@register_model
def p3db_resnet50(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _p3db_resnet('resnet50', Bottleneck, [3, 4, 6, 3], pooling_arch,
                   **kwargs)


@register_model
def p3db_resnet101(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _p3db_resnet('resnet101', Bottleneck, [3, 4, 23, 3], pooling_arch,
                   **kwargs)
                   

@register_model
def p3db_resnet103(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _p3db_resnet('resnet103', Bottleneck, [3, 4, 23, 3], pooling_arch, deep_stem=True,
                   **kwargs)


@register_model
def p3db_resnet152(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _p3db_resnet('resnet152', Bottleneck, [3, 8, 36, 3], pooling_arch,
                   **kwargs)


@register_model
def p3db_resnext50_32x4d(pooling_arch, **kwargs):
    ...
    return _p3db_resnet('resnext50_32x4d', Bottleneck, [3, 4, 6, 3],
                   pooling_arch, **kwargs)


@register_model
def p3db_resnext101_32x8d(pooling_arch, **kwargs):
    ...
    return _p3db_resnet('resnext101_32x8d', Bottleneck, [3, 4, 23, 3],
                   pooling_arch, **kwargs)


@register_model
def p3db_wide_resnet50_2(pooling_arch, **kwargs):
    ...
    return _p3db_resnet('wide_resnet50_2', Bottleneck, [3, 4, 6, 3],
                   pooling_arch, **kwargs)


@register_model
def p3db_wide_resnet101_2(pooling_arch, **kwargs):
    ...
    """
    kwargs['width_per_group'] = 64 * 2
    return _p3db_resnet('wide_resnet101_2', Bottleneck, [3, 4, 23, 3],
                   pooling_arch, **kwargs)
