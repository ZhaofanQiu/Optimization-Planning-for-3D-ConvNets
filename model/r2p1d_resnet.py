...
__all__ = ['R2P1D_ResNet', 'r2p1d_resnet18', 'r2p1d_resnet34', 'r2p1d_resnet50', 'r2p1d_resnet101', 'r2p1d_resnet103',
           'r2p1d_resnet152', 'r2p1d_resnext50_32x4d', 'r2p1d_resnext101_32x8d',
           'r2p1d_wide_resnet50_2', 'r2p1d_wide_resnet101_2']
...
def _r2p1d_resnet(arch, block, layers, pooling_arch, image_size=None, **kwargs):
    model = R2P1D_ResNet(block, layers, pooling_arch, **kwargs)
    return model


@register_model
def r2p1d_resnet18(pooling_arch, **kwargs):
    ...
    """
    return _r2p1d_resnet('resnet18', BasicBlock, [2, 2, 2, 2], pooling_arch,
                   **kwargs)


@register_model
def r2p1d_resnet34(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _r2p1d_resnet('resnet34', BasicBlock, [3, 4, 6, 3], pooling_arch,
                   **kwargs)


@register_model
def r2p1d_resnet50(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _r2p1d_resnet('resnet50', Bottleneck, [3, 4, 6, 3], pooling_arch,
                   **kwargs)


@register_model
def r2p1d_resnet101(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _r2p1d_resnet('resnet101', Bottleneck, [3, 4, 23, 3], pooling_arch,
                   **kwargs)


@register_model
def r2p1d_resnet103(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _r2p1d_resnet('resnet103', Bottleneck, [3, 4, 23, 3], pooling_arch, deep_stem=True,
                   **kwargs)


@register_model
def r2p1d_resnet152(pooling_arch, **kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _r2p1d_resnet('resnet152', Bottleneck, [3, 8, 36, 3], pooling_arch,
                   **kwargs)


@register_model
def r2p1d_resnext50_32x4d(pooling_arch, **kwargs):
    ...
    return _r2p1d_resnet('resnext50_32x4d', Bottleneck, [3, 4, 6, 3],
                   pooling_arch, **kwargs)


@register_model
def r2p1d_resnext101_32x8d(pooling_arch, **kwargs):
    ...
    return _r2p1d_resnet('resnext101_32x8d', Bottleneck, [3, 4, 23, 3],
                   pooling_arch, **kwargs)


@register_model
def r2p1d_wide_resnet50_2(pooling_arch, **kwargs):
    ...
    return _r2p1d_resnet('wide_resnet50_2', Bottleneck, [3, 4, 6, 3],
                   pooling_arch, **kwargs)


@register_model
def r2p1d_wide_resnet101_2(pooling_arch, **kwargs):
    ...
    """
    kwargs['width_per_group'] = 64 * 2
    return _r2p1d_resnet('wide_resnet101_2', Bottleneck, [3, 4, 23, 3],
                   pooling_arch, **kwargs)
