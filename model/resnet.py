...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet103',
           'resnet152', 'resnext50_32x4d', 'resnext101_32x8d', 'resnext103_64x4d',
...
def _resnet(arch, block, layers, pooling_arch, image_size=None, early_stride=None, **kwargs):
...
@register_model
def resnext103_64x4d(pooling_arch, **kwargs):
    r"""ResNeXt-101 32x8d model from
    `"Aggregated Residual Transformation for Deep Neural Networks" <https://arxiv.org/pdf/1611.05431.pdf>`_
    ...
    kwargs['groups'] = 64
    kwargs['width_per_group'] = 4
    return _resnet('resnext103_64x4d', Bottleneck, [3, 4, 23, 3],
