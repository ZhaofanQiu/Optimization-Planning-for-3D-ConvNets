...
__all__ = ['SeqResNet', 'seq_resnet18', 'seq_resnet34', 'seq_resnet50', 'seq_resnet101', 'seq_resnet103',
           'seq_resnet152', 'seq_resnext50_32x4d', 'seq_resnext101_32x8d',
           'seq_wide_resnet50_2', 'seq_wide_resnet101_2']
...
class SeqResNet(nn.Module):
    ...
    def __init__(self, block, layers, pooling_arch, early_stride=4, num_classes=1000, dropout_ratio=0.5, zero_init_residual=False,
...
def _resnet(arch, block, layers, pooling_arch, image_size=None, **kwargs):
    model = SeqResNet(block, layers, pooling_arch, **kwargs)
    return model


@register_model
def seq_resnet18(pooling_arch, **kwargs):
...
@register_model
def seq_resnet34(pooling_arch, **kwargs):
...
@register_model
def seq_resnet50(pooling_arch, **kwargs):
...
@register_model
def seq_resnet101(pooling_arch, **kwargs):
...
@register_model
def seq_resnet103(pooling_arch, **kwargs):
...
@register_model
def seq_resnet152(pooling_arch, **kwargs):
...
@register_model
def seq_resnext50_32x4d(pooling_arch, **kwargs):
...
@register_model
def seq_resnext101_32x8d(pooling_arch, **kwargs):
...
@register_model
def seq_wide_resnet50_2(pooling_arch, **kwargs):
...
@register_model
def seq_wide_resnet101_2(pooling_arch, **kwargs):
