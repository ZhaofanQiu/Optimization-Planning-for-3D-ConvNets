"""
Calculate flops
This implementation is based on https://github.com/facebookresearch/fvcore/blob/main/tests/test_flop_count.py
...
def get_jit_model_analysis(
    ...
    for node in trace_nodes:
        ...
        # print(f'op_count: {op_count}, total_count: {total_count}')
